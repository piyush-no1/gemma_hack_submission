...
async def extract_and_upscale_frames_node(state: PipelineState) -> dict:
    ...
    timestamps = scene_extraction_service.extract_keyframe_timestamps(video_path, max_frames=30)
    ...
    for idx, ts in enumerate(timestamps):
        ...
        if ret:
            ...
            # Ensure dimensions are multiples of 8 to prevent ONNX CUDA assertion errors.
            h, w = frame.shape[:2]
            if w > 768:
                ratio = 768.0 / w
